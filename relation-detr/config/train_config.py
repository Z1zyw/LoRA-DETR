...
# model_path = "configs/lora_relation_detr/lora_relation_detr_res50_800_1333.py" # res: lora1/3 mAP 52.3/52.5
# model_path = "configs/lora_relation_detr/lora_relation_detr_swinL_800_1333.py" # res: mAP 58.2
model_path = "configs/lora_relation_detr/ufusion_lora_relation_detr_swinL_800_1333.py" # res: mAP 58.4
